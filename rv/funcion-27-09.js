...
VENTANA.listener =function()
{
  ...
  VENTANA.redenderizador.setsize(window.innerWidth, window.innerHeight);
}
...
VENTANA.camara = new THREE.PerspectiveCamera(75,window.innerwidth / window.innerHeiht, 0.1, 1000);
...
VENTANA.malla= new THREE.Mesh(new THREE.BoxGeometry(1,1,1), new THREE.MesNormalMaterial());
